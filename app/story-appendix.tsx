    ...
    <section className="story-section evidence-section" id="evidence" aria-labelledby="evidence-title">
      ...
      <div className="evidence-reader">
        <details className="evidence-method">
          ...
          <p>{t('Observação descreve algo já conhecido. Pergunta deixa uma questão em aberto. Alerta aponta um risco. Recomendação propõe um caminho. Uma passagem pode fazer mais de uma dessas coisas. Essas categorias ajudam a distinguir o que os autores afirmavam daquilo que deixavam em discussão.', 'An observation describes something already known. A question leaves an issue open. A warning identifies a risk. A recommendation suggests a direction. A passage may do more than one of these things. These categories help distinguish what the authors asserted from what they left open for discussion.')}</p>
