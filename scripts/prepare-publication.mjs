...
for (const file of ['index.html', 'pt.html', 'en.html', 'en/home.html', 'sobre.html', 'en/about.html', 'oceano.html', 'en/ocean.html', 'projetos.html', 'en/projects.html']) {
...
for (const route of ['pt', 'en', 'en/home', 'sobre', 'en/about', 'oceano', 'en/ocean', 'projetos', 'en/projects']) {
...
console.log('Public export ready: ten portfolio pages; four design previews kept local.');
